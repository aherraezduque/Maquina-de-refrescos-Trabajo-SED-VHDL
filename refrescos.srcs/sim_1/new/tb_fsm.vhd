...
architecture tb of tb_fsm is
    ...
    component fsm           
        port (CLK                 : in std_logic;
              ...
              SELECTOR            : in std_logic_vector (0 to 3);
    ...
    signal SELECTOR            : std_logic_vector (0 to 3);--:= (others=>'0');
    signal LIGHT               : std_logic_vector (0 to 3);--:= (others=>'0');
    ...
    TYPE vtest is record
        ...
        SELECTOR_vt            : std_logic_vector (0 to 3);
        LIGHT_vt               : std_logic_vector (0 to 3);
        SALDO_vt               : integer ;
